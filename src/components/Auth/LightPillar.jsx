...
const LightPillar = ({
  ...
  if (!webGLSupported) {
    return (
      <div
        // Disini gua ganti class manual jadi class Tailwind (flex, absolute, dll)
        className={`flex items-center justify-center bg-black/10 text-gray-500 text-sm w-full h-full absolute top-0 left-0 ${className}`}
        style={{ mixBlendMode }}
      >
        WebGL not supported
      </div>
  ...
  return (
    <div
      ref={containerRef}
      // Disini juga, ganti .light-pillar-container jadi class Tailwind
